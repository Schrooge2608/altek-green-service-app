...
export function UserAuthForm({ mode, onSuccess }: UserAuthFormProps) {
  ...
  const getFormSchema = () => {
    if (mode === 'createUser') {
      return formSchema.required({ name: true, role: true, password: true });
    }
      ...
      <div className={cn('grid gap-6')}>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="name@altekgreen.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="space-y-1">
              ...
              {mode === 'login' && (
                <div className="flex justify-end">
                  ...
                  >
                    {isResetting ? <Loader2 className="h-3 w-3 animate-spin mr-1" /> : <KeyRound className="h-3 w-3 mr-1" />}
                    Forgot password?
                  </Button>
                </div>
              )}
            ...
            <Button disabled={isLoading || isResetting} className="w-full">
