...
export function EditProtectionForm({ equipment }: EditProtectionFormProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const updateData = {
        ...
        protectionAssignedToId: values.protectionAssignedToId === 'unassigned' ? '' : values.protectionAssignedToId,
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        <div className="grid gap-4">
                            ...
                            <FormField control={form.control} name="breakerServiceDescription" render={({ field }) => (<FormItem><FormLabel>Service / Description</FormLabel><FormControl><Textarea placeholder="What does it feed?" {...field} value={field.value ?? ''} /></FormControl><FormMessage /></FormItem>)} />
