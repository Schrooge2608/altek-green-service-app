  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-8 bg-background">
      <div className="flex justify-end mb-4 gap-2 print:hidden items-center">
        ...
        <Button onClick={handleSaveProgress} disabled={isSaving || isReadOnly}>
                ...
                <TableBody>
                    {annualChecklistItems.map((item, index) => {
                        ...
                        <TableRow key={index}>
                            ...
                            <TableCell>
                               <Input placeholder="Comments..." value={checklist[checklistIndex]?.comments || ''} onChange={(e) => handleChecklistChange(checklistIndex, 'comments', e.target.value)} disabled={isReadOnly} />
                            </TableCell>
                            <TableCell>
