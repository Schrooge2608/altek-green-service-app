...
interface WorkCrewMemberWithLocalId extends WorkCrewMember {
    localId: number;
}
                ...
                <Table>
                    ...
                    <TableBody>
                        {crew.map((member, index) => (
                            <WorkCrewRow key={member.localId} onRemove={() => removeCrewMember(member.localId)} onChange={(field, value) => handleCrewChange(index, field, value)} users={users} usersLoading={usersLoading} member={member} disabled={isReadOnly} />
                        ))}
                    </TableBody>
                </Table>
            </div>
