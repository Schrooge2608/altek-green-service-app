...
export const seedEquipment: Equipment[] = [
    ...
    {
        id: "ps-monzi-pump-02",
        name: "Monzi Pump No. 2",
        type: "Pump",
        location: "Monzi Pump Station",
        plant: "Mining",
        division: "Pump Stations",
        vsdId: "vsd-ps-monzi-pump-02",
        model: "Solcon SOFT STARTER",
        serialNumber: "SN-PS-MONZI-02",
        status: "active",
        installationDate: installationDate,
        lastMaintenance: format(today, "yyyy-MM-dd"),
        nextMaintenance: format(new Date(new Date().setMonth(today.getMonth() + 3)), "yyyy-MM-dd"),
        uptime: 99.5,
        powerConsumption: 28000,
        assignedToId: '',
        assignedToName: '',
    },
    {
        id: "ps-monzi-pump-1-1",
        name: "Monzi Pump No. 1.1",
        type: "Pump",
        location: "Monzi Pump Station",
        plant: "Mining",
        division: "Pump Stations",
        vsdId: "vsd-ps-monzi-pump-1-1",
        model: "ABB ACS800",
        serialNumber: "SN-PS-MONZI-1-1",
        status: "active",
        installationDate: installationDate,
        lastMaintenance: format(today, "yyyy-MM-dd"),
        nextMaintenance: format(new Date(new Date().setMonth(today.getMonth() + 3)), "yyyy-MM-dd"),
        uptime: 99.9,
        powerConsumption: 29500,
        assignedToId: '',
        assignedToName: '',
    },
];
