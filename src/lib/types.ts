export interface Equipment {
  ...
  division?: 'Boosters' | 'Dredgers' | 'Pump Stations' | 'MSP' | 'Roaster' | 'Char Plant' | 'Smelter' | 'Iron injection' | 'Stripping Crane' | 'Slag plant' | 'North Screen' | "UPS/BTU's" | "MPE Dry Mining" | "MPC Dry Mining" | "Concentrator Plant" | "Surge Bin" | "Tails Boosters" | "Cons Boosters" | "Dry Mining";
  vsdId: string;
  mcc?: string;
