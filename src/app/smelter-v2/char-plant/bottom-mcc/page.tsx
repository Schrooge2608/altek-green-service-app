...
export default function CharPlantBottomMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Charplant Bottom MCC / E10')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Vibrating feeder East (1)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Vibrating feeder West (1)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Vibrating feeder East (2)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Vibrating feeder West (2)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Screw Conveyor 1", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Screw Conveyor 2", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Screw Conveyor 3", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Rotary Valve 3", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Charplant Bottom MCC / E10 equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Charplant Bottom MCC / E10</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=Charplant Bottom MCC / E10&plant=Smelter&division=Char Plant&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by Charplant Bottom MCC / E10.
          </CardDescription>
        </CardHeader>
