...
export default function WestCranePage() {
  ...
  // Query equipment specifically for this division/MCC
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'West Crane MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Main hoist 1", type: "VSD", manufacturer: "Siemens", model: "Masterdrive", mcc: "West Crane MCC" },
      { name: "Main hoist 2", type: "VSD", manufacturer: "Siemens", model: "Masterdrive", mcc: "West Crane MCC" },
      { name: "Long travel", type: "VSD", manufacturer: "Siemens", model: "Masterdrive", mcc: "West Crane MCC" },
      { name: "Aux hoist", type: "VSD", manufacturer: "Siemens", model: "Masterdrive", mcc: "West Crane MCC" },
      { name: "Cross travel", type: "VSD", manufacturer: "Siemens", model: "Masterdrive", mcc: "West Crane MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "West Crane equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">West Crane</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Iron Injection&mcc=West Crane MCC&location=Iron Injection`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for the West Crane.
          </CardDescription>
        </CardHeader>
