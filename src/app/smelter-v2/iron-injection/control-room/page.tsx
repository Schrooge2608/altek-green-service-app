...
export default function ControlRoomPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Control room Sub station')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Turn Table", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Control room Sub station" },
      { name: "Injection station hood 1", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Control room Sub station" },
      { name: "Injection station hood 2", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Control room Sub station" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Control Room Sub Station equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Control Room Sub Station</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Iron Injection&mcc=Control room Sub station&location=Iron Injection`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for the Turn Table & Fumehood.
          </CardDescription>
        </CardHeader>
