...
export default function IronInjectionDashboard() {
  const areas = [
    {
      name: 'West Crane',
      route: '/smelter-v2/iron-injection/west-crane',
      description: 'West Crane MCC',
      icon: Zap,
      color: 'bg-red-600',
    ...
    {
      name: 'East Crane',
      route: '/smelter-v2/iron-injection/east-crane',
      description: 'East Crane MCC',
      icon: Zap,
      color: 'bg-orange-600',
      buttonText: 'View Equipment'
    },
    {
      name: 'Control Room Sub Station',
      route: '/smelter-v2/iron-injection/control-room',
      description: 'Turn Table & Fumehood',
      icon: Zap,
      color: 'bg-yellow-600',
      buttonText: 'View Equipment'
    },
    {
      name: 'PCM',
      route: '/smelter-v2/iron-injection/pcm',
      description: 'PCM 1 & 2 MCC',
      icon: Zap,
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Iron Injection</h1>
