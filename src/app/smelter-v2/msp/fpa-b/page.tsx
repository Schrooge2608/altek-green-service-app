...
export default function FPABPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'FPA/B MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Pump 7A", type: "VSD", manufacturer: "Siemens", model: "Master Drive" },
      { name: "Pump 7B", type: "VSD", manufacturer: "Siemens", model: "Master Drive" },
      { name: "Pump 7C", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Secondary WHIMS 1A Rectifier", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex DC" },
      { name: "Secondary WHIMS 2A Rectifier", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex DC" },
      { name: "Primary WHIMS 2A Rectifier", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex DC" },
      { name: "Primary WHIMS 1A Rectifier", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex DC" },
      { name: "Cleaner WHIMS 3A Rectifier", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex DC" },
      { name: "Secondary WHIMS 1A Rectifier (PF40)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Secondary WHIMS 2A Rectifier (PF40)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Primary WHIMS 2A Rectifier (PF40)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Primary WHIMS 1A Rectifier (PF40)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Cleaner WHIMS 3A Rectifier (PF40)", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "FPA/B MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">FPA/B MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=FPA/B MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the FPA/B MCC.
          </CardDescription>
        </CardHeader>
