...
export default function PilotPlantPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'PILOT PLANT MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Feed Pump 2", type: "VSD", manufacturer: "Siemens MM440", model: "Micromaster 440" },
      { name: "Rougher Pump 3", type: "VSD", manufacturer: "Siemens MM440", model: "Micromaster 440" },
      { name: "Cleaner Feed Pump 7", type: "VSD", manufacturer: "Siemens MM440", model: "Micromaster 440" },
      { name: "Scavenger Feed Pump 10", type: "VSD", manufacturer: "Siemens MM440", model: "Micromaster 440" },
      { name: "Pump 12", type: "VSD", manufacturer: "Siemens MM440", model: "Micromaster 440" },
      { name: "Pump 13", type: "VSD", manufacturer: "Siemens MM440", model: "Micromaster 440" },
      { name: "Ore Kinetics Seperator 1", type: "VSD", manufacturer: "Danfoss", model: "VLT 2800" },
      { name: "Ore Kinetics Seperator 2", type: "VSD", manufacturer: "Danfoss", model: "VLT 2800" },
      { name: "Vibrator Feeder No. 1 & 2", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Drum Roll Motor", type: "VSD", manufacturer: "Siliconics", model: "Unknown" },
      { name: "Feed Roll Motor (1)", type: "VSD", manufacturer: "DART", model: "DC Drive" },
      { name: "Feed Roll Motor (2)", type: "VSD", manufacturer: "DART", model: "DC Drive" },
      { name: "Perm Roll Motor 1", type: "VSD", manufacturer: "DART", model: "DC Drive" },
      { name: "Perm Roll Motor 2", type: "VSD", manufacturer: "DART", model: "DC Drive" },
      { name: "Perm Roll Motor 3", type: "VSD", manufacturer: "DART", model: "DC Drive" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "PILOT PLANT MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=PILOT PLANT MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the PILOT PLANT MCC.
          </CardDescription>
        </CardHeader>
