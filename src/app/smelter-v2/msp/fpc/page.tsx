...
export default function FPCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'FPC MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Pump 19A", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 19B", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 19C", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 34B", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 34D", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 34F", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 35B", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 35F", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 35K", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 42 (1)", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Pump 42 (2)", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Pump 41 (1)", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Pump 41 (2)", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Pump 40 (1)", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Pump 40 (2)", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Conveyor 48B", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Conveyor 48A", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 6", type: "VSD", manufacturer: "Siemens", model: "Masterdrive" },
      { name: "Conveyor 47", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Pump 32C (Sump 32)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Pump 33C (Sump 32)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "WIMS cleaner 4", type: "VSD", manufacturer: "Siemens", model: "Simoreg DC" },
      { name: "Pump 24C RFS Transfer Pump", type: "Soft Starter", manufacturer: "Allen-Bradley SMC-Flex", model: "SMC-FLEX" },
      { name: "Pump 43", type: "Soft Starter", manufacturer: "Allen-Bradley SMC-Flex", model: "SMC-FLEX" },
      { name: "Pump 44", type: "Soft Starter", manufacturer: "Allen-Bradley SMC-Flex", model: "SMC-FLEX" },
      { name: "Pump 45", type: "Soft Starter", manufacturer: "Allen-Bradley SMC-Flex", model: "SMC-FLEX" },
      { name: "Pump 34 A", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Pump 34 C", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Pump 34 E", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX" },
      { name: "Pump 35A", type: "Soft Starter", manufacturer: "Phasecon", model: "SF6000" },
      { name: "Pump 35E", type: "Soft Starter", manufacturer: "Phasecon", model: "SF6000" },
      { name: "Pump 35 J", type: "Soft Starter", manufacturer: "Allen-Bradley SMC-Flex", model: "SMC-FLEX" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "FPC MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">FPC MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=FPC MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the FPC MCC.
          </CardDescription>
        </CardHeader>
