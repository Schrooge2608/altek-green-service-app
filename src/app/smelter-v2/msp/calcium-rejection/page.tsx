...
export default function CalciumRejectionPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'CALCIUM REJ MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Make up pump 67 VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 60C VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 60B VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 60A VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 61A VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 61B VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 61C VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 70 VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 66 softstarter", type: "Soft Starter", manufacturer: "Control Techniques", model: "GPS 250" },
      { name: "Pump 65 softstarter", type: "Soft Starter", manufacturer: "Control Techniques", model: "GPS 250" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Calcium Rejection MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">CALCIUM REJ MCC</h1>
            <p className="text-muted-foreground font-medium uppercase text-[10px] tracking-[0.2em] mt-1 flex items-center gap-2">
              <MapPin className="h-3 w-3 text-primary" />
              Smelter • MSP • Calcium Rejection
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=CALCIUM REJ MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the Calcium Rejection MCC.
          </CardDescription>
        </CardHeader>
