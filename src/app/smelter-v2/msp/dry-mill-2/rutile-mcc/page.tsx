...
export default function DM2RutileMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'DM2 - RUTILE MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Pump 5 E - FPC pump VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 5 D - Stock feed pump VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 5 B - Feed pump VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Primary HTR Bank A", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Primary HTR Bank B", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Primary HTR Bank C", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Primary HTR Bank D", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Scavenger HTR Bank A", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Scavenger HTR Bank B", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Scavenger HTR Bank C", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Scavenger HTR Bank D", type: "VSD", manufacturer: "Allen-Bradley", model: "Powerflex 525" },
      { name: "Rutile Main Air Fan2", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Rutile Dryer Exhaust Air Fan 4", type: "VSD", manufacturer: "ABB", model: "ACS880" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "DM2 - RUTILE MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">DM2 - RUTILE MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=DM2 - RUTILE MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the DM2 - RUTILE MCC.
          </CardDescription>
        </CardHeader>
