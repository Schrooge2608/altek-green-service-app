...
export default function DryMill2Dashboard() {
  const mccs = [
    {
      name: 'DM2 Zircon MCC',
      route: '/smelter-v2/msp/dry-mill-2/zircon-mcc',
      description: 'Zircon MCC for Dry Mill 2',
      icon: Factory,
      color: 'bg-emerald-600'
    },
    {
      name: 'DM2 Services MCC',
      route: '/smelter-v2/msp/dry-mill-2/services-mcc',
      description: 'Services MCC for Dry Mill 2',
      icon: Factory,
      color: 'bg-blue-600'
    },
    {
      name: 'DM2 Rutile MCC',
      route: '/smelter-v2/msp/dry-mill-2/rutile-mcc',
      description: 'Rutile MCC for Dry Mill 2',
      icon: Factory,
      color: 'bg-orange-600'
    }
  ];
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Dry Mill 2</h1>
