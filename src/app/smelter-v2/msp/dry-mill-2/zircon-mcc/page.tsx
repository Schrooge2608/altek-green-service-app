...
export default function DM2ZirconMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'DM2 - ZIRCON MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Perm Roll 2 (1)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 2 (2)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 2 (3)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 2 (4)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 3 (1)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 3 (2)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 3 (3)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 3 (4)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Zircon Filter Vacuum Pump 39", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX" },
      { name: "Zircon tertiary Circuit Elevator 17", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX" },
      { name: "Zircon Exhaust Air Fan 18", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Zircon Main Air Fan16", type: "VSD", manufacturer: "ABB", model: "ACS880" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "DM2 - ZIRCON MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">DM2 - ZIRCON MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=DM2 - ZIRCON MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the DM2 - ZIRCON MCC.
          </CardDescription>
        </CardHeader>
