...
export default function DM2ServicesMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'DM2 - SERVICES MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Tank 2 feed pump 2A", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Tank 2 feed pump 2B", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Tank 2 feed pump 2C", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Tank 1 feed pump 1A", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Tank 1 feed pump 1B", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Fan services building ventilation Fan 30", type: "Soft Starter", manufacturer: "Smart start", model: "HSMD170" },
      { name: "Fan services building ventilation Fan 31", type: "Soft Starter", manufacturer: "Smart start", model: "HSMD170" },
      { name: "Fan 32", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Fan 33", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Fan 34", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Fan 35", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Fan 36", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Fan 37", type: "Soft Starter", manufacturer: "Natronics", model: "TC900" },
      { name: "Stockpile feedpump 22B", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX" },
      { name: "Wet Zircon feed 22 A", type: "VSD", manufacturer: "ABB", model: "ACS800" },
      { name: "Wet Zircon feed Pump 35", type: "VSD", manufacturer: "ABB", model: "ACS880" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "DM2 - SERVICES MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=DM2 - SERVICES MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the DM2 - SERVICES MCC.
          </CardDescription>
        </CardHeader>
