...
export default function NZTPDashboard() {
  const mccs = [
    {
      name: 'LIME SHED',
      route: '/smelter-v2/msp/nztp/lime-shed',
      description: 'Lime Shed Area',
      icon: Factory,
      color: 'bg-emerald-600'
    },
    {
      name: 'NZTP CALCINER MCC',
      route: '/smelter-v2/msp/nztp/calciner-mcc',
      description: 'Calciner MCC',
      icon: Factory,
      color: 'bg-blue-600'
    },
    {
      name: 'NZTP DSA ROOM',
      route: '/smelter-v2/msp/nztp/dsa-room',
      description: 'DSA Room',
      icon: Factory,
      color: 'bg-orange-600'
    }
  ];
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">NZTP</h1>
