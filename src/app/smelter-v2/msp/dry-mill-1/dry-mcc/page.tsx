...
export default function DM1DryMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'DM 1 - DRY MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const baseItems = [
      { name: "Pulse motor VSD", type: "VSD", manufacturer: "Siemens", model: "Midimaster Vector" },
      { name: "Spin motor VSD", type: "VSD", manufacturer: "Siemens", model: "Midimaster Vector" },
      { name: "Rutile feed pump 5C VSD", type: "VSD", manufacturer: "Control Techniques", model: "UNISP" },
      { name: "Rutile dryer exhaust fan softstarter", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Zircon dryer exhaust fan softstarter", type: "Soft starter", manufacturer: "Siliconics", model: "GPS-2" },
      { name: "Smoker Baghouse Fan 6A", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Primary Sampler (1)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Primary Sampler (2)", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440" },
      { name: "Perm Roll 2 Feeder", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
      { name: "Perm Roll 3 Feeder", type: "VSD", manufacturer: "Allen Bradley", model: "Powerflex 40" },
    ];
    
    const generateNumberedItems = (prefix: string, count: number, type: string, manufacturer: string, model: string) => 
    ...
    const items = [
      ...baseItems,
      ...generateNumberedItems("Zircon re-cleaner magnet no", 4, "VSD", "Allen Bradley", "Powerflex 525"),
      ...generateNumberedItems("Zircon cleaner magnet no", 5, "VSD", "Allen Bradley", "Powerflex 525"),
      ...generateNumberedItems("Rutile HT Primary Bank A Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Rutile HT Primary Bank B Module", 5, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Rutile HT Primary Bank C Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Rutile HT Primary Bank D Module", 5, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Rutile Recleaner HT Primary A Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Scavenger Bank A Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Scavenger Bank B Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Scavenger Bank C Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Scavenger Bank D Module", 4, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Secondary Module", 11, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Cleaner Module", 5, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Zircon HT Bank A Module", 5, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Zircon HT Bank B Module", 5, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Zircon HT Bank C Module", 3, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Perm Roll 2 Magnet", 3, "VSD", "Allen Bradley", "Powerflex 40"),
      ...generateNumberedItems("Perm Roll 3 Magnet", 3, "VSD", "Allen Bradley", "Powerflex 40"),
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "DM 1 - DRY MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/smelter-v2/msp/dry-mill-1">
            <Button variant="ghost" size="icon" className="rounded-full hover:bg-slate-200">
              <ArrowLeft className="h-5 w-5" />
            </Button>
          </Link>
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">DM 1 - DRY MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=DM 1 - DRY MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the DM 1 - DRY MCC.
          </CardDescription>
        </CardHeader>
