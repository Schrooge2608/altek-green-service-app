...
export default function DM1WetMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'DM 1 - WET MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Tank 10 pump 10C VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" }, // From col D model
      { name: "Tank 10 pump 10B VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Tank 10 pump 10A VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
      { name: "Pump 8A VSD", type: "VSD", manufacturer: "ABB", model: "ACS880" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "DM 1 - WET MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">DM 1 - WET MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=DM 1 - WET MCC&plant=Smelter&division=MSP&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the DM 1 - WET MCC.
          </CardDescription>
        </CardHeader>
