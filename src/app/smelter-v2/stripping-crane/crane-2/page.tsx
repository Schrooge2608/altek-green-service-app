...
export default function Crane2Page() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Stripping Crane 2 MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Main Hoist", type: "VSD", manufacturer: "Demag", model: "ACS800", mcc: "Stripping Crane 2 MCC" },
      { name: "Auxiliary hoist", type: "VSD", manufacturer: "ABB", model: "ACS880", mcc: "Stripping Crane 2 MCC" },
      { name: "Cross travel", type: "VSD", manufacturer: "Demag", model: "ACS800", mcc: "Stripping Crane 2 MCC" },
      { name: "Long travel", type: "VSD", manufacturer: "Demag", model: "ACS800", mcc: "Stripping Crane 2 MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Stripping Crane 2 equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Stripping Crane 2</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Stripping Cranes&mcc=Stripping Crane 2 MCC&location=Stripping Cranes`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for Stripping Crane 2.
          </CardDescription>
        </CardHeader>
