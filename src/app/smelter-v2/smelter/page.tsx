...
const locations = [
  {
    name: 'MSP',
    route: '/smelter-v2/msp',
    description: 'MSP Area',
    icon: Factory,
    color: 'bg-red-500'
  },
  {
    name: 'Roaster',
    route: '/smelter-v2/roaster',
    description: 'Roaster Plant',
    icon: Factory,
    color: 'bg-orange-500'
  },
  {
    name: 'Char Plant',
    route: '/smelter-v2/char-plant',
    description: 'Char Plant',
    icon: Factory,
    color: 'bg-yellow-500'
  },
  {
    name: 'Smelter',
    route: '/smelter-v2/smelter/area',
    description: 'Smelter Core',
    icon: Factory,
    color: 'bg-red-600'
  },
  {
    name: 'Iron Injection',
    route: '/smelter-v2/iron-injection',
    description: 'Iron Injection',
    icon: Factory,
    color: 'bg-amber-600'
  },
  {
    name: 'Stripping Cranes',
    route: '/smelter-v2/stripping-crane',
    description: 'Stripping Cranes',
    icon: Factory,
    color: 'bg-orange-600',
  ...
  {
    name: 'Slag Plant',
    route: '/smelter-v2/slag-plant',
    description: 'Slag Plant',
    icon: Factory,
    color: 'bg-stone-500'
  },
  {
    name: 'North Screen',
    route: '/smelter-v2/north-screen',
    description: 'North Screen',
    icon: Factory,
    color: 'bg-zinc-500',
...
export default function SmelterV2DashboardPage() {
  return (
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Smelter Equipment (v2)</h1>
