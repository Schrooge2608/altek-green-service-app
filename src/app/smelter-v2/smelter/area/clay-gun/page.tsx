...
export default function ClayGunPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('division', '==', 'Smelter - Clay Gun')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Claygun 2 long travel controller", type: "VSD", manufacturer: "Danfoss", model: "VLT5008", mcc: "Claygun 2" },
      { name: "Claygun 3 long travel controller", type: "VSD", manufacturer: "Danfoss", model: "VLT5008", mcc: "Claygun 3" },
      { name: "Claygun 4 long travel controller", type: "VSD", manufacturer: "Danfoss", model: "VLT5008", mcc: "Claygun 4" },
      { name: "Claygun 5 long travel controller", type: "VSD", manufacturer: "Danfoss", model: "VLT5008", mcc: "Claygun 5" },
      { name: "Claygun 6 long travel controller", type: "VSD", manufacturer: "Danfoss", model: "VLT5008", mcc: "Claygun 6" },
      { name: "Claygun 7 long travel controller", type: "VSD", manufacturer: "Danfoss", model: "VLT5008", mcc: "Claygun 7" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Smelter Clay Gun equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Smelter - Clay Gun</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Smelter - Clay Gun&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for the Clay Gun controllers.
          </CardDescription>
        </CardHeader>
