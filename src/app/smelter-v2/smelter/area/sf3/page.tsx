...
export default function SF3Page() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('division', '==', 'Smelter - SF3')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Electrode drives no.1", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
      { name: "Electrode drives no.2", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
      { name: "Electrode drives no.3", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
      { name: "Electrode drives no.4", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
      { name: "Electrode drives no.5", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
      { name: "Electrode drives no.6", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
      { name: "Electrode drives no.7", type: "VSD", manufacturer: "Control Techniques", model: "M700", mcc: "Furnace 3 MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Smelter SF3 equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Smelter - SF3</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Smelter - SF3&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for SF3.
          </CardDescription>
        </CardHeader>
