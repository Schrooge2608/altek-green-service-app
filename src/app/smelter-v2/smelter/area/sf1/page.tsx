...
export default function SF1Page() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('division', '==', 'Smelter - SF1')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Electrode drive no.1", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
      { name: "Electrode drive no.2", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
      { name: "Electrode drive no.3", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
      { name: "Electrode drive no.4", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
      { name: "Electrode drive no.5", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
      { name: "Electrode drive no.6", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
      { name: "Electrode drive no.7", type: "VSD", manufacturer: "Control Techniques", model: "UNISP", mcc: "Furnace 1 MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Smelter SF1 equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Smelter - SF1</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Smelter - SF1&location=Smelter`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for SF1.
          </CardDescription>
        </CardHeader>
