...
export default function SmelterCoreDashboard() {
  const areas = [
    {
      name: 'SF1',
      route: '/smelter-v2/smelter/area/sf1',
      description: 'Furnace 1 Area',
      icon: Zap,
      color: 'bg-red-600',
    ...
    {
      name: 'Common',
      route: '/smelter-v2/smelter/area/common',
    ...
    {
      name: 'SF2',
      route: '/smelter-v2/smelter/area/sf2',
      description: 'Furnace 2 Area',
      icon: Zap,
      color: 'bg-yellow-600',
      buttonText: 'View Equipment'
    },
    {
      name: 'SF3',
      route: '/smelter-v2/smelter/area/sf3',
      description: 'Furnace 3 Area',
      icon: Zap,
    ...
    {
      name: 'SF4',
      route: '/smelter-v2/smelter/area/sf4',
      description: 'Furnace 4 Area',
      icon: Zap,
      color: 'bg-cyan-600',
      buttonText: 'View Equipment'
    },
    {
      name: 'Clay Gun',
      route: '/smelter-v2/smelter/area/clay-gun',
      description: 'Clay Gun Controllers',
      icon: Zap,
      color: 'bg-blue-600',
      buttonText: 'View Equipment'
    },
    {
      name: 'Elevator',
      route: '/smelter-v2/smelter/area/elevator',
      description: 'Smelter Elevator',
      icon: Zap,
      color: 'bg-indigo-600',
      buttonText: 'View Equipment'
    }
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Smelter Core</h1>
