...
export default function SlagMccPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Slag MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Brute course silo no.1", type: "VSD", manufacturer: "Danfoss", model: "VLT FC302", mcc: "Slag MCC" },
      { name: "Brute course silo no.2", type: "VSD", manufacturer: "Danfoss", model: "VLT FC302", mcc: "Slag MCC" },
      { name: "Brute course silo no.3", type: "VSD", manufacturer: "Danfoss", model: "VLT FC302", mcc: "Slag MCC" },
      { name: "Chain conveyor", type: "VSD", manufacturer: "Danfoss", model: "VLT FC302", mcc: "Slag MCC" },
      { name: "Aerofall Mill Main Air Fan", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Slag MCC" },
      { name: "Aerofall Mill Main Drive", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Slag MCC" },
      { name: "Aerofall Mill Bag House Exhaust Fan", type: "VSD", manufacturer: "Siemens", model: "G150 Sinamics", mcc: "Slag MCC" },
      { name: "Coarse Silo Scrubber Fan", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440", mcc: "Slag MCC" },
      { name: "North screen Bag House / Fan 1", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440", mcc: "Slag MCC" },
      { name: "South Screen Bag House / Fan 2", type: "VSD", manufacturer: "Siemens", model: "Micromaster 440", mcc: "Slag MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Slag MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/smelter-v2/slag-plant">
            <Button variant="ghost" size="icon" className="rounded-full hover:bg-slate-200">
              <ArrowLeft className="h-5 w-5" />
            </Button>
          </Link>
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Slag MCC</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-lg border border-emerald-100">
            ...
            <span className="text-[10px] font-black text-emerald-800 uppercase tracking-widest">Area Online</span>
          </div>
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Slag Plant&mcc=Slag MCC&location=Slag Plant`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for Slag MCC.
          </CardDescription>
        </CardHeader>
