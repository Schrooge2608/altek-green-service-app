...
export default function CoolingWaterPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Slag Cooling Water MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Slag Cooling Water Pump 1", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Slag Cooling Water MCC" },
      { name: "Slag Cooling Water Pump 2", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Slag Cooling Water MCC" },
      { name: "Slag Cooling Water Pump 3", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Slag Cooling Water MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Slag Cooling Water MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Slag Cooling Water MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Slag Plant&mcc=Slag Cooling Water MCC&location=Slag Plant`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for Slag Cooling Water.
          </CardDescription>
        </CardHeader>
