...
export default function HadfieldMccPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Hadfield Crusher MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Hadfield Jaw Crusher", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Hadfield Crusher MCC" },
      { name: "S3 Conveyor", type: "Soft Starter", manufacturer: "Allen-Bradley", model: "SMC-FLEX", mcc: "Hadfield Crusher MCC" },
      { name: "Osbourne Crusher", type: "VSD", manufacturer: "ABB", model: "ACS880", mcc: "Hadfield Crusher MCC" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "Hadfield Crusher MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Hadfield Crusher MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?plant=Smelter&division=Slag Plant&mcc=Hadfield Crusher MCC&location=Slag Plant`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems for Hadfield Crusher MCC.
          </CardDescription>
        </CardHeader>
