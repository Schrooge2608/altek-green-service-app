...
export default function MPCConcentratorMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPC Concentrator MCC C1')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "C1 Primary Feed Pump", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1 Cleaner Feed", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C1 Cleaner Mids / SCAVENGER MIDS", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C1-1 Final Cons", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1-2 Final Cons", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1 Scavenger Feed", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1-1 Tails", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1-2 Tails", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1 Tails Densifier", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "MPC Concentrator MCC C1 equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPC Concentrator MCC C1&plant=Mining&division=Concentrator&location=MPC`}>
