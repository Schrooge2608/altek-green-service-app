...
export default function MPCConsBoostersMCCPage() {
  const firestore = useFirestore();
  const { toast } = useToast();
  const [isSeeding, setIsSeeding] = useState(false);

  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPC Cons Boosters MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items: any[] = [
      { name: "Cons Booster 1 - PUMP 1", manufacturer: "ABB", model: "ABB ACS 800", assigned: "Ntokozo" },
      { name: "Cons Booster 1 - PUMP 2", manufacturer: "ABB", model: "ABB ACS 800", assigned: "Ntokozo" },
      { name: "Cons Booster 1 - PUMP 3", manufacturer: "ABB", model: "ABB ACS 800", assigned: "Ntokozo" },
      { name: "Cons Booster 1 - PUMP 4", manufacturer: "ABB", model: "ABB ACS 800", assigned: "Ntokozo" },
      { name: "Cons Booster 5 - PUMP 1", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 5 - PUMP 2", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 5 - PUMP 3", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 5 - PUMP 4", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 6 - PUMP 1", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 6 - PUMP 2", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 6 - PUMP 3", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 6 - PUMP 4", manufacturer: "ABB", model: "ABB ACS 600", assigned: "Ntokozo" },
      { name: "Cons Booster 4 - PUMP 1", manufacturer: "ABB", model: "ABB ACS 800", assigned: "Ntokozo" }
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          location: 'MPC',
          plant: 'Mining',
          division: 'Cons Boosters',
          mcc: 'MPC Cons Boosters MCC',
          vsdId: vsdId,
          assignedToName: item.assigned,
      ...
      toast({ title: "Success", description: "MPC Cons Boosters MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPC Cons Boosters MCC&plant=Mining&division=Cons Boosters&location=MPC`}>
