...
export default function MPCConsBoostersNodesPage() {
  return (
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">MPC: CONS BOOSTERS</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="group hover:shadow-xl transition-all duration-300 border-slate-200">
          <CardHeader className="pb-2 space-y-1">
            ...
            <CardTitle className="text-xl font-black text-slate-800 uppercase tracking-tight">MPC Cons Boosters MCC</CardTitle>
          ...
          <CardContent className="pt-4">
            <Link href="/mining/ponds/mpc/cons-boosters/mcc">
