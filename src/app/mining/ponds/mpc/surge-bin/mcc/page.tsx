...
export default function MPCSurgeBinMCCPage() {
  const firestore = useFirestore();
  const { toast } = useToast();
  const [isSeeding, setIsSeeding] = useState(false);

  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPC Surge Bin MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "C1 Magnetite Pump", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C1 Cleaner Tails Scavenger", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C1 Tails Transfer Pump", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C1 Cleaner Mids", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C2 Magnetite Pump", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C2 Cleaner Tails Scavenger", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
      { name: "C2 Tails Transfer Pump", manufacturer: "ABB", model: "ACS607", assigned: "Ntokozo" },
      { name: "C2 Cleaner Mids", manufacturer: "ABB", model: "ACS880", assigned: "Ntokozo" },
    ];
    ...
    try {
      ...
      await setDoc(doc(collection(firestore, 'equipment'), btuId), {
        id: btuId,
        name: 'MPC Surge Bin Cooling Unit',
        location: 'MPC',
        plant: 'Mining',
        division: 'Surge Bin',
        mcc: 'MPC Surge Bin MCC',
      ...
      toast({ title: "Success", description: "MPC Surge Bin MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPC Surge Bin MCC&plant=Mining&division=Surge Bin&location=MPC`}>
