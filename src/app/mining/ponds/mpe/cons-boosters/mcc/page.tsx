...
export default function MPEConsBoostersMCCPage() {
  const firestore = useFirestore();
  const { toast } = useToast();
  const [isSeeding, setIsSeeding] = useState(false);

  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPE Cons Boosters MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Cons Booster 1 - PUMP 1", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 1 - PUMP 2", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 1 - PUMP 3", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 1 - PUMP 4", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 2 - PUMP 1", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 2 - PUMP 2", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 2 - PUMP 3", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 2 - PUMP 4", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 3 - PUMP 1", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 3 - PUMP 2", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 3 - PUMP 3", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" },
      { name: "Cons Booster 3 - PUMP 4", manufacturer: "Siemens", model: "Sinamics G150", assigned: "Ntokozo" }
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "MPE Cons Boosters MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPE Cons Boosters MCC&plant=Mining&division=Cons Boosters&location=MPE`}>
