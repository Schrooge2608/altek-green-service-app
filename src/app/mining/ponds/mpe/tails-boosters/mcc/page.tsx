...
export default function MPETailsBoostersMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPE Tails Boosters MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "TB03", model: "Sinamics G150", manufacturer: "Siemens", assigned: "Ntokozo" },
      { name: "TB07", model: "Sinamics G150", manufacturer: "Siemens", assigned: "Ntokozo" },
      { name: "TB12", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB13", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB14", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB15", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB16", model: "Sinamics G150", manufacturer: "Siemens", assigned: "Ntokozo" },
      { name: "TB17", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB21", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB24", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB25", model: "ABB ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB27", model: "ABB ACS 800", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB29", model: "Sinamics G150", manufacturer: "Siemens", assigned: "Ntokozo" },
      { name: "TB30", model: "ABB ACS 880", manufacturer: "ABB", assigned: "Ntokozo" }
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          location: 'MPE',
          plant: 'Mining',
          division: 'Tails Boosters',
          mcc: 'MPE Tails Boosters MCC',
          vsdId: vsdId,
          assignedToName: item.assigned,
      ...
      toast({ title: "Success", description: "MPE Tails Boosters MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href={`/equipment/new?mcc=MPE Tails Boosters MCC&plant=Mining&division=Tails Boosters&location=MPE`}>
