...
export default function MPEDredgeMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPE Dredge 2 MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Dredge 2 Main Pump No. 1", model: "ACS600", assigned: "Ntokozo" },
      { name: "Dredge 2 Main Pump No. 2", model: "ACS600", assigned: "Ntokozo" },
      { name: "Dredge 2 Ladder Winch", model: "ACS600", assigned: "Ntokozo" },
      { name: "Dredge 2 Swing Winch Right", model: "ACS600", assigned: "Ntokozo" },
      { name: "Dredge 2 Swing Winch Left", model: "ACS600", assigned: "Ntokozo" },
      { name: "Dredge 2 Spud Carriage Motor", model: "ACS600", assigned: "Ntokozo" }
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          plant: 'Mining',
          division: 'Dredgers',
          mcc: 'MPE Dredge 2 MCC', // New hierarchical field
          vsdId: vsdId,
      ...
      await setDoc(doc(collection(firestore, 'equipment'), upsId), {
        id: upsId,
        name: 'MPE Dredge 2 UPS 1',
        location: 'MPE',
        plant: 'Mining',
        division: 'Dredgers',
        mcc: 'MPE Dredge 2 MCC',
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPE Dredge 2 MCC&plant=Mining&division=Dredgers&location=MPE`}>
