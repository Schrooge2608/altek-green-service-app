...
/**
 * @fileOverview Node dashboard for MPE Dredge 1.
 * Lists the physical control nodes like the main MCC.
 */
export default function MPEDredge1NodesPage() {
  return (
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">MPE: DREDGE 1</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="group hover:shadow-xl transition-all duration-300 border-slate-200">
          ...
          <CardContent className="pt-4">
            <Link href="/mining/ponds/mpe/dredge-1/mcc">
