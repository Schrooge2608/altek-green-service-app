...
export default function MPEConsE2DriveRoomPage() {
  const firestore = useFirestore();
  const { toast } = useToast();
  const [isSeeding, setIsSeeding] = useState(false);

  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPE Cons E2 Drive Room')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items: any[] = [
      { name: "Cleaner Feed Pump E2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Cons Pump E2-1", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Cons Pump E2-2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Cleaner Tails Pump E2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Scavenger Pump E2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Magnetite Pump E2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Tails Cyclone E2 Pu 38", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Tails Densifier Pump E2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Tails Pump 3-1", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Tails Pump 3-2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Tails Pump 4-1", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Tails Pump 4-2", manufacturer: "ABB", model: "ACS600", assigned: "Ntokozo" },
      { name: "Cons Stacker Return Water BB", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "E-House 2 UPS", manufacturer: "Pending", model: "N/A", assigned: "Ntokozo" },
      { name: "E-House 2 BTU", manufacturer: "Pending", model: "N/A", assigned: "Ntokozo" }
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          location: 'MPE',
          plant: 'Mining',
          division: 'Concentrator Plant',
          mcc: 'MPE Cons E2 Drive Room',
          vsdId: vsdId,
          assignedToName: item.assigned,
      ...
      toast({ title: "Success", description: "MPE Cons E2 Drive Room equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPE Cons E2 Drive Room&plant=Mining&division=Concentrator Plant&location=MPE`}>
