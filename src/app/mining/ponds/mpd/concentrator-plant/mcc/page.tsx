...
export default function MPDConcentratorMCCPage() {
  const firestore = useFirestore();
  const { toast } = useToast();
  const [isSeeding, setIsSeeding] = useState(false);

  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPD Cons Plant D1 MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "D1-1 Tails Pump", model: "ACS880", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "D1 Cleaner Feed Pump", model: "ACS880", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "D1 Scavenger Mids Pump", model: "ACS880", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "D1 Tails Densifier Pump", model: "ACS880", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "D1-2 Tails Pump", model: "ACS880", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "D1-1 F/Cons Transport Pump", model: "ACS800", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "D1-2 F/Cons Transport Pump", model: "ACS800", manufacturer: "ABB", assigned: "Ntokozo" },
    ];
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPD Cons Plant D1 MCC&plant=Mining&division=Concentrator Plant&location=MPD`}>
