...
export default function MPDTailsBoostersMCCPage() {
  const firestore = useFirestore();
  const { toast } = useToast();
  const [isSeeding, setIsSeeding] = useState(false);

  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPD Tails Boosters MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "TB01", model: "ACS 800", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB02", model: "Sinamics G150", manufacturer: "Siemens", assigned: "Ntokozo" },
      { name: "TB12", model: "Sinamics G150", manufacturer: "Siemens", assigned: "Ntokozo" },
      { name: "TB18", model: "ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB19", model: "ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB20", model: "ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB25", model: "ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
      { name: "TB26", model: "ACS 600", manufacturer: "ABB", assigned: "Ntokozo" },
    ];
    ...
    try {
      ...
      toast({ title: "Success", description: "MPD Tails Boosters MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href={`/equipment/new?mcc=MPD Tails Boosters MCC&plant=Mining&division=Tails Boosters&location=MPD`}>
