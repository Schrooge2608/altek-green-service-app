...
export default function MPDDredgeMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPD Dredger MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Dredge Main Pump No. 1", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Main Pump No. 2", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Ladder Winch", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Swing Winch Left", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Swing Winch Right", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Spud Carriage Motor", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Hydraulic Motor 1 Cutter wheel", model: "ACS880", assigned: "Ntokozo" },
      { name: "Dredge Hydraulic Motor 2 Cutter wheel", model: "ACS880", assigned: "Ntokozo" }
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          plant: 'Mining',
          division: 'Dredgers',
          mcc: 'MPD Dredger MCC', // New hierarchical field
          vsdId: vsdId,
          assignedToName: item.assigned,
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPD Dredger MCC&plant=Mining&division=Dredgers&location=MPD`}>
