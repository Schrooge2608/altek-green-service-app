...
/**
 * @fileOverview Node dashboard for MPA Dredgers.
 * Lists the physical control nodes like the main MCC.
 */
export default function MPADredgersNodesPage() {
  return (
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">MPA: DREDGERS</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="group hover:shadow-xl transition-all duration-300 border-slate-200">
          ...
          <CardContent className="pt-4">
            <Link href="/mining/ponds/mpa/dredgers/mcc">
      ...
      <footer className="mt-12 pt-8 border-t border-dashed border-slate-200 text-center">
        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.3em]">
          Altek Green (v2) Asset Register • MPA Dredgers Control Hierarchy
        </p>
      </footer>
    </div>
  );
