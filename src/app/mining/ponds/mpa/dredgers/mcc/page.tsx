...
export default function DredgeMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPA Dredger MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Main Pump No. 1", model: "ACS800", assigned: "Ntokozo" },
      { name: "Main Pump No. 2", model: "ACS800", assigned: "Ntokozo" },
      { name: "Hydraulic Motor 1 Cutter wheel", model: "ACS800", assigned: "Ntokozo" },
      { name: "Hydraulic Motor 2 Cutter wheel", model: "ACS800", assigned: "Ntokozo" }, // Assuming the duplicate was Motor 2
      { name: "Ladder Winch", model: "ACS800", assigned: "Ntokozo" },
      { name: "Swing Winch Right", model: "ACS800", assigned: "Ntokozo" },
      { name: "Swing Winch Left", model: "ACS800", assigned: "Ntokozo" },
      { name: "Spud Carriage Motor", model: "ACS800", assigned: "Ntokozo" },
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          plant: 'Mining',
          division: 'Dredgers',
          mcc: 'MPA Dredger MCC', // New hierarchical field
          vsdId: vsdId,
          assignedToName: item.assigned,
      ...
      toast({ title: "Success", description: "Dredge MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPA Dredger MCC&plant=Mining&division=Dredgers&location=MPA`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the Dredge MCC.
          </CardDescription>
        </CardHeader>
