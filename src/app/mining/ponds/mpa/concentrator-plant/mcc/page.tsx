...
export default function ConcentratorMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'MPA Concentrator MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Magnetite Feed Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Cleaner Feed Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Cleaner Transfer Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Final Cons Pump 1", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Final Cons Pump 2", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Cleaner Tails Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Scavenger Feed Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Scavenger Mids Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "1st Stage Tails Pump", manufacturer: "Siemens DC Drive", model: "6RM8095", assigned: "Ntokozo" },
      { name: "2nd Stage Tails Pump", manufacturer: "Siemens DC Drive", model: "6RM8095", assigned: "Ntokozo" },
      { name: "Tails Densifier Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
      { name: "Tails Transfer Pump", manufacturer: "ABB", model: "ACS800", assigned: "Ntokozo" },
    ];
    ...
    try {
      for (const item of items) {
        ...
        await setDoc(doc(collection(firestore, 'equipment'), eqId), {
          ...
          location: 'MPA',
          plant: 'Mining',
          division: 'Concentrator Plant', // Following the same pattern
          mcc: 'MPA Concentrator MCC',
          vsdId: vsdId,
          assignedToName: item.assigned,
      ...
      toast({ title: "Success", description: "MPA Concentrator MCC equipment list has been populated." });
    } catch (error) {
      console.error(error);
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=MPA Concentrator MCC&plant=Mining&division=Concentrator Plant&location=MPA`}>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription className="text-xs text-slate-500">
            Manage all variable speed drives, motors, and protection systems powered by the Concentrator MCC.
          </CardDescription>
        </CardHeader>
