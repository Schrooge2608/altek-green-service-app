...
const locations = [
  {
    name: 'Nhlabane',
    route: '/mining/pump-stations/nhlabane',
    description: 'Nhlabane Pump Station',
    icon: Droplets,
    color: 'bg-blue-600'
  },
  {
    name: 'Mposa',
    route: '/mining/pump-stations/mposa',
    description: 'Mposa Pump Station',
    icon: Droplets,
    color: 'bg-blue-700'
  },
  {
    name: 'Monzi',
    route: '/mining/pump-stations/monzi',
    description: 'Monzi Pump Station',
    icon: Droplets,
    color: 'bg-cyan-600'
  },
  {
    name: 'Return Water Boosters',
    route: '/mining/pump-stations/return-water',
    description: 'RWBS Infrastructure',
    icon: Waves,
    color: 'bg-cyan-700'
  }
];
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Pump Stations</h1>
            ...
            <CardContent className="pt-4">
              <Link href={loc.route}>
                <Button className="w-full bg-slate-900 hover:bg-primary group-hover:shadow-lg transition-all font-bold uppercase text-[10px] tracking-widest">
                  View Sub Systems <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
            </CardContent>
          </Card>
        ...
        <CardContent className="p-12 text-center space-y-4">
           ...
           <div className="space-y-1">
             ...
             <p className="text-sm text-slate-500 max-w-lg mx-auto">
               This v2 dashboard is designed for high-precision asset tracking. Select a pump station above to view the detailed equipment hierarchy.
             </p>
           </div>
        </CardContent>
      </Card>
