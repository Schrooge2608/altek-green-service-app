...
export default function MonziMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Monzi MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Pump No. 1", brand: "ABB", model: "ABB ACS800", assigned: "Ntokozo", category: "VSD" },
      { name: "Pump No. 2", brand: "Solcon", model: "SOFT STARTER", assigned: "Ntokozo", category: "VSD" },
      { name: "Monzi UPS", brand: "Eaton", model: "9SX", assigned: "Ntokozo", category: "UPS" },
      { name: "Monzi Cooling Unit", brand: "Daikin", model: "Split Type", assigned: "Ntokozo", category: "BTU" },
    ];
    ...
    try {
      ...
      toast({
        ...
        description: "Monzi equipment has been added.",
      });
    } catch (error) {
    ...
    if (confirm("Are you sure you want to delete all equipment in this MCC?")) {
      try {
        ...
        toast({
          ...
          description: "All Monzi MCC equipment has been deleted.",
        });
      } catch (error) {
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">MONZI MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=Monzi MCC&plant=Mining&division=Pump Stations&location=Monzi`}>
