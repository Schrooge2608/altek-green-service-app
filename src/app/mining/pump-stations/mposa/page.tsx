...
export default function MposaMCCPage() {
  ...
  const equipmentQuery = useMemoFirebase(
    () => query(collection(firestore, 'equipment'), where('mcc', '==', 'Mposa MCC')),
    [firestore]
  );
  ...
  const handleSeedData = async () => {
    ...
    const items = [
      { name: "Pump set 1 - Stage 1", brand: "Schneider", model: "ALTISTART 48 S/S", assigned: "Ntokozo", category: "VSD" },
      { name: "Pump set 1 - Stage 2", brand: "Schneider", model: "ALTISTART 48 S/S", assigned: "Ntokozo", category: "VSD" },
      { name: "Pump set 2 - Stage 1", brand: "Schneider", model: "ALTISTART 48 S/S", assigned: "Ntokozo", category: "VSD" },
      { name: "Pump set 2 - Stage 2", brand: "Schneider", model: "ALTISTART 48 S/S", assigned: "Ntokozo", category: "VSD" },
      { name: "Pump set 3 - Stage 1", brand: "Schneider", model: "ALTISTART 48 S/S", assigned: "Ntokozo", category: "VSD" },
      { name: "Pump set 3 - Stage 2", brand: "Schneider", model: "ALTISTART 48 S/S", assigned: "Ntokozo", category: "VSD" },
      { name: "Mposa UPS", brand: "Eaton", model: "9SX", assigned: "Ntokozo", category: "UPS" },
      { name: "Mposa Cooling Unit", brand: "Daikin", model: "Split Type", assigned: "Ntokozo", category: "BTU" },
    ];
    ...
    try {
      ...
      toast({
        ...
        description: "Mposa equipment has been added.",
      });
    } catch (error) {
    ...
    if (confirm("Are you sure you want to delete all equipment in this MCC?")) {
      try {
        ...
        toast({
          ...
          description: "All Mposa MCC equipment has been deleted.",
        });
      } catch (error) {
    ...
    <div className="flex flex-col gap-8 p-4 md:p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase">MPOSA MCC</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/equipment/new?mcc=Mposa MCC&plant=Mining&division=Pump Stations&location=Mposa`}>
                ...
                <TableRow>
                  <TableCell colSpan={5} className="h-48 text-center text-slate-500">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-xs text-slate-400 mt-1">Use the Add Equipment button to populate pumps.</p>
                    </div>
                  </TableCell>
                </TableRow>
              )}
