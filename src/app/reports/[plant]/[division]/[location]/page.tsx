...
export default function EquipmentReportPage() {
    ...
    const divisionName = useMemo(() => {
        ...
        if (divisionSlug in divisions) {
            return (divisions as any)[divisionSlug];
        }
        return '';
    }, [plantSlug, divisionSlug]);

    const locationName = useMemo(() => (locationSlug ? decodeURIComponent(locationSlug) : 'Unknown'), [locationSlug]);
            ...
            <div className="grid gap-8">
                 <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Click a bar to view equipment details. Uptime percentage for each piece of equipment.</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Equipment Power Consumption</CardTitle>
                         <CardDescription>Click a bar to view equipment details. Total power consumption (MWh) for each piece of equipment.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {isLoading ? <Skeleton className="h-[350px] w-full" /> : (
                           <ChartContainer config={chartConfig} className="min-h-[200px] w-full">
