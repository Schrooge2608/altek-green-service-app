...
export default function ViewReportPage() {
    ...
    const shareText = `Weekly Report: ${report.startDate} to ${report.endDate}\n${shareUrl}`;
        ...
        <div className="max-w-4xl mx-auto p-4 sm:p-8">
            ...
            <div className="flex flex-wrap justify-end mb-4 gap-2 print:hidden">
                ...
                <Button 
                  ...
                  className="gap-2"
                  onClick={() => {
                      window.open(`mailto:?subject=Weekly Report: ${report.startDate} to ${report.endDate}&body=${encodeURIComponent(shareText)}`, '_blank');
                  }}
                >
